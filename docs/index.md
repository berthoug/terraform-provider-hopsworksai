...
- `api_gateway` (String) URL of the API Gateway to use. It is intended for development purposes only. Defaults to `https://4mlcusfv9d.execute-api.us-east-2.amazonaws.com/gautiertwo`.
